...
public class ShippingItems {
	...
	public static void main(String[] args) throws IOException {
		...
		if (nbrOfItems * weightEachItem < containerCapacity) {
			...
			System.out.println("Number of items that can be shipped in a container : "
					+ containerCapacity / weightEachItem + "\n" + "Number of items left out : "
					+ (int) Math.ceil(((nbrOfItems * weightEachItem) - containerCapacity) / weightEachItem));
		}
